                    ...
                    <form action="{{ route('expenses.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-input id="amount" class="block mt-1 w-full" type="number" name="amount" :value="old('amount')" required step="0.01" />
                            </div>
                            ...
                            <div>
                                ...
                                <select name="recurrence_frequency" id="recurrence_frequency" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                                    ...
                                    <option value="monthly" {{ old('recurrence_frequency') == 'monthly' ? 'selected' : '' }}>Mensual</option>
                            ...
                            <div class="flex items-center">
                                <label class="inline-flex items-center">
                                    <input type="checkbox" name="tax_deductible" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('tax_deductible') ? 'checked' : '' }}>
