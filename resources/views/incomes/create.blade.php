                    ...
                    <form method="POST" action="{{ route('incomes.store') }}">
                        ...
                        <div class="mt-4">
                            <label for="is_recurring" class="inline-flex items-center">
                                <input id="is_recurring" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="is_recurring">
